...
\item An experiment is conducted, and the velocity of an object is
  ...
  \begin{subproblem}
  \item Assume that the object starts at the position 0m and the
...
\begin{eqnarray*}
  \frac{f(b)-f(a)}{b-a}.
\end{eqnarray*}
Geometrically this is equivalent to the \textbf{slope} of the
straight line that goes through the two points. If the function is the
